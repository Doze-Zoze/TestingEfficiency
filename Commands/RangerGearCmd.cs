...
public class RangerGearCmd : ModCommand
{
	public override CommandType Type => CommandType.Chat;

	public override string Command => "ranger";

	public override string Description => "Equip Ranger Gear";
	...
	public override void Action(CommandCaller caller, string input, string[] args)
	{
		...
		Dictionary<string, List<string>> gear = TestingLoadouts.Instance.rangerLoadouts;
