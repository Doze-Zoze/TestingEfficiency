...
public class RogueGearCmd : ModCommand
{
    public override CommandType Type => CommandType.Chat;

    public override string Command => "rogue";

    public override string Description => "Equip Rogue Gear";
    ...
    public override void Action(CommandCaller caller, string input, string[] args)
    {
        ...
        Dictionary<string, List<string>> gear = TestingLoadouts.Instance.rogueLoadouts;
